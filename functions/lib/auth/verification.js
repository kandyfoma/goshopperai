...
async function sendSMS(phoneNumber, code) {
  ...
  try {
    ...
    const response = await fetch(
      `${config_1.config.sms.baseUrl}/version1/messaging`,
      {
        method: 'POST',
        headers: {
    ...
    return (
      ((_c =
        (_b =
          (_a = result.SMSMessageData) === null || _a === void 0
            ? void 0
            : _a.Recipients) === null || _b === void 0
          ? void 0
          : _b[0]) === null || _c === void 0
        ? void 0
        : _c.statusCode) === 101
  ...
  .https.onCall(async (data, context) => {
    ...
    try {
      ...
      const userProfileRef = db.doc(
        `${config_1.collections.users(userId)}/profile`,
      );
      const updateData = {
        verified: true,
        verifiedAt: admin.firestore.FieldValue.serverTimestamp(),
