  ...
  .https.onCall(async (data, context) => {
    ...
    try {
      ...
      const response = await axios_1.default.post(
        `${config_1.config.moko.baseUrl}/payments/initiate`,
        mokoPayload,
        {
          headers: {
      ...
      if (axios_1.default.isAxiosError(error)) {
        const errorMessage =
          ((_b =
            ...
            ? void 0
            : _b.message) || 'Payment service unavailable';
  ...
  .https.onCall(async (data, context) => {
    ...
    try {
      ...
      const response = await axios_1.default.get(
        `${config_1.config.moko.baseUrl}/payments/status/${
      ...
      const mokoStatus =
        (_a = response.data.status) === null || _a === void 0
          ? void 0
          : _a.toUpperCase();
...
exports.mokoPaymentWebhook = functions
  ...
  .https.onRequest(async (req, res) => {
    ...
    try {
      const userId =
        metadata === null || metadata === void 0 ? void 0 : metadata.user_id;
      if (!userId) {
