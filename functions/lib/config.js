...
exports.collections = {
  ...
  userDoc: userId =>
    `artifacts/${exports.config.app.id}/users/${userId}/profile/data`,
  receipts: userId =>
    `artifacts/${exports.config.app.id}/users/${userId}/receipts`,
  subscription: userId =>
    `artifacts/${exports.config.app.id}/users/${userId}/subscription/status`,
  prices: `artifacts/${exports.config.app.id}/public/prices/data`,
  stores: `artifacts/${exports.config.app.id}/public/stores/data`,
  payments: userId =>
    `artifacts/${exports.config.app.id}/users/${userId}/payments`,
};
